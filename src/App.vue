...
import { SunIcon, Bars3Icon, MoonIcon } from '@heroicons/vue/24/solid'
...
// to remove the sidebar entirely, remove any expressions using this variable
...
<template>
  <div>
    ...
    >
      <header class="flex bg-gray-900" :class="{ 'lg:hidden': sidebarEnabled }">
        <router-link
          :to="{ name: 'home' }"
